...
const Primary = ({ isClient }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center p-[10px] ">
            {isClient && (
                <ReactPlayer
                    url="https://www.youtube.com/watch?v=ZGElK1N_Xdk"
                    controls
                    playing={true}
                    loop
                    muted={true}
            ...
            <div className="flex flex-col w-[80%] p-[5px] text-[#FFFFFF] pt-[15px]">
                <div className="flex justify-between p-[5px]">
                    <div className="flex gap-[20px]">
                        <Image src='/avatar1.png' width={45} height={45} className="rounded-[50%]" />
                ...
                <div className="flex pt-[20px] gap-[15px]">
                    ...
                    <input type="text" placeholder="Add a public comment..." onChange={add} className="border-0 bg-[#121212]"/>
                </div>
                <div>
                    <Image src='/profile.svg' width={40} height={40}/>
                    <div>
